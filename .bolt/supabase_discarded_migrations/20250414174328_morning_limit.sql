...
DROP POLICY IF EXISTS "Allow public access to imagensdocs" ON storage.objects;
DROP POLICY IF EXISTS "Allow authenticated users to upload to imagensdocs" ON storage.objects;
DROP POLICY IF EXISTS "Allow authenticated users to update in imagensdocs" ON storage.objects;
DROP POLICY IF EXISTS "Allow authenticated users to delete from imagensdocs" ON storage.objects;
